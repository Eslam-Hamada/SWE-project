...
<html>
<head>
	<title>MTJ login and signup</title>
	<meta charset="utf-8">
...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white;">MTJ Community</h1></center>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-6" style="left:0.5%;">
			<img src="images/mario-gogh-1140530-unsplash.jpg" class="img-rounded" title="MTJ" width="650px" height="565px">
		...
		<div class="col-sm-6" style="left:8%:">
			<img src="images/social-3408791_1920.jpg" class="img-rounded" title="MTJ" width="80px" height="80px">
			<h2><strong>See what's happening in <br> the world right now</strong></h2><br><br>
			<h4><strong>join MTJ Today.</strong></h4>

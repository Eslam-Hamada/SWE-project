...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$rand = rand(1, 3); //Random number between 1 and 3
			...
			if($rand == 1)
				$profile_pic = "676215.jpg";
			else if($rand == 2)
				$profile_pic = "12.jpg";
			else if($rand == 3)
				$profile_pic = "559477.png";
		...
		values('$first_name','$last_name','$username','Hello MTJ Community.This is my default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
